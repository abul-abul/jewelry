	...
	<div class="container">
		<div class="page-top-in">
			<ol class="breadcrumb pull-left">
				...
				@endif
				<li>
					<a href="{{URL::to('item/items',['category', $breadcrumb, 'noSort'])}}">{{$breadcrumb}}</a>
				</li>
				<li>
					{{$type}}
				</li>
			...
			<div class="breadcrumb  pull-right">
				<div class="btn-group">
	               ...
	               <ul  class="dropdown-menu sort" role="menu" >
	                   <li>
	                       <a href="{{URL::to('item/items-list',['category', $breadcrumb, $type, 'name'])}} " >@if($sort == 'name')<i style="color:white" class="fa fa-check"></i>@endif NAME</a>
	                   </li>
	                   <li>
	                       <a  href="{{URL::to('item/items-list',['category', $breadcrumb,  $type, 'price'])}}" >@if($sort == 'price')<i style="color:white" class="fa fa-check"></i>@endif PRICE</a>
	                   </li>
	                   <li>
	                       <a   href="{{URL::to('item/items-list',['category', $breadcrumb,  $type, 'noSort'])}}" >@if($sort == 'noSort')<i style="color:white" class="fa fa-check"></i>@endif POSITION</a> 
	                   </li>
	               </ul>
	           </div>
				<div class="btn-group" >
	               ...
	               <span style="color:black;font-family: Roboto Slab, serif; margin-top: 4px; margin-left: 5px;">&nbsp;{{session()->get('number')}} items</span>
	           </div>
           </div>
		</div>
	</div>
