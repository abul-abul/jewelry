			...
			<div class="breadcrumb pull-right">
				<div class="btn-group">
	               ...
	               <ul class="dropdown-menu sort" role="menu" >
	                   <li>
	                       <a href="{{URL::to('item/sort-type','name')}}" > @if(Session::get('sort') == 'name')<i style="color:white" class="fa fa-check"></i>@endif NAME</a>
	                   </li>
	                   <li>
	                       <a  href="{{URL::to('item/sort-type','price')}}" > @if(Session::get('sort') == 'price')<i style="color:white" class="fa fa-check"></i>@endif PRICE</a>
	                   </li>
	                   <li>
	                       <a href="{{URL::to('item/sort-type','noSort')}}" > @if(Session::get('sort') != 'price' && Session::get('sort') != 'name')<i style="color:white" class="fa fa-check"></i>@endif POSITION</a>
	                   </li>
	               </ul>
	           </div> 
		        <div class="btn-group">
			...
			<aside class="sidebar">
				<aside class="block filter-blk">
							...
							<aside class="block blk-cat"> 
								...
								<input @if(isset($searchData['price_min'])) value="{{$searchData['price_min']}}" @endif type="number" min="0" name="price_min" style="width: 60px; border-color: #666666" placeholder=" min"/> - <input @if(isset($searchData['price_max'])) value="{{$searchData['price_max']}}" @endif type="number" min="0" name ="price_max" style="width: 60px; border-color:#666666" placeholder=" max" /><b class="symbol">{{$currencySymbol}}</b>
					...
					<div class="tab-content">
						<div class="tab-pane active" id="man">
							...
							@if(count($items) > 0)
								...
								<input type="hidden" name="search_results[]" value="{{$item->id}}" />
