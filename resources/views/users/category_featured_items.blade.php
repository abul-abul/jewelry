	...
	<div class="container">
		<div class="page-top-in">
			<ol class="breadcrumb pull-left">
				...
				<li>
					<a href="/item/featured-products/noSort"> Featured Products </a>
				</li>
				<li>
					{{$category}}
				</li>
			...
			<ol class="breadcrumb pull-right">
				<div class="btn-group">
	               ...
	               <ul  class="dropdown-menu sort" role="menu" >
	                   <li>
	                       <a href="/item/category-items/{{$category}}/name"> @if($sort == 'name')<i style="color:white" class="fa fa-check"></i>@endif NAME</a>
	                   </li>
	                   <li>
	                       <a  href="/item/category-items/{{$category}}/price" > @if($sort == 'price')<i style="color:white" class="fa fa-check"></i>@endif PRICE</a>
	                   </li>
	                   <li>
	                       <a   href="/item/category-items/{{$category}}/noSort" > @if($sort == 'noSort')<i style="color:white" class="fa fa-check"></i>@endif POSITION</a>
	                   </li>
	               </ul>
	           </div> 
		        <div class="btn-group">
