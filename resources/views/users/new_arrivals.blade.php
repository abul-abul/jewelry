...
@section('content')
<!-- Begin Main -->
<h1 class="home_title">new arrivals jewellery</h1>
			...
			<div class="breadcrumb pull-right">			
					<div class="btn-group " >
                       ...
                       <ul  class="dropdown-menu sort" role="menu" >
                           <li>
                               <a href="{{URL::to('item/new-arrivals','name')}} " >@if($sort == 'name')<i style="color:white" class="fa fa-check"></i>@endif NAME </a>
                           </li>
                           <li>
                               <a  href="{{URL::to('item/new-arrivals','price')}}" >@if($sort == 'price')<i style="color:white" class="fa fa-check"></i>@endif PRICE</a>
                           </li>
                           <li>
                               <a href="{{URL::to('item/new-arrivals','noSort')}}" >@if($sort == 'noSort')<i style="color:white" class="fa fa-check"></i>@endif POSITION</a> 
                           </li> 
                       </ul>
                    </div>
                    <div class="btn-group">
...
<!-- 		<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
			...
			<ul class="ietm_ul_ul">
				...
				<li>
					<b><a href="{{URL::to('item/items',['category', $category->category, 'noSort'])}}">{{$category->category}}</a></b>
				</li>
				@endforeach
			</ul>
									...
									<div class="product">
										<div class="product-thumb-info">
											<div class="product-thumb-info-image">
												...
												@endif
												<span class="product-thumb-info-act product-thumb-info-act-new-arrivals">
													@if(Auth::check())
													...
													@endif
														...
														@else
														<a class="add-to-cart-product item_list{{$item->id}}" data-id="{{$item->id}}" data-subtotal = "{{$subtotal}}" data-title = "{{$item->title}}" data-category = "{{$item->category->category}}" data-price = "{{$item->new_price}}" href="#" data-toggle="modal">
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
            	<label id="item_page" data-dismiss="modal">Please visit item's page to select size! </label>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
